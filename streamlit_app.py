...
def fetch_roads(_api, area_id):
    ...
    (
        ...
        way(area.a)["highway"~"residential|unclassified|tertiary|secondary|track"]["highway"!="footway"]["surface"~"unpaved|wood|compacted|fine_gravel|gravel|pebblestone|grass|dirt|earth|mud|sand|ground"];
        way(area.a)["highway"~"residential|unclassified|tertiary|secondary|track"]["highway"!="footway"]["tracktype"~"grade[1-5]"];
